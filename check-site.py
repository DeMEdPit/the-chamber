...
def check_inputs():
    for f in ("surface/surface.json", "architecture/findings.json", "machine/parts/MANIFEST.json", "machine/catalogue.json", "machine/ports.json", "machine/instruments.json"):
        try:
