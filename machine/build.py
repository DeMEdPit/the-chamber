...
<div class="machine">
  ...
  <aside class="column">
    ...
    <section class="panel keys" aria-labelledby="lab-keys">
      ...
      <p class="grp">PLAY</p>
      <dl class="keys">
        <dt>INPUT</dt><dd><select class="mode" id="input-mode" aria-label="what the arrow keys feed" autocomplete="off"><option value="joystick" selected>joystick in port 2</option><option value="joystick1">joystick in port 1</option><option value="keyboard">the keyboard</option></select> <span class="hint">what the arrows and letters feed; AUTO sets it for each program; a game that ignores the stick may read port 1</span></dd>
