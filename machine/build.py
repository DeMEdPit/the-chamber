...
.lede{{margin:0 0 18px;color:var(--muted);font-weight:450;line-height:1.4;font-size:clamp(.95rem,2.6vw,1.05rem);max-width:48ch}}   /* a compact block under the title, about 48 characters a line, not a band across the page */
