  ...
  <aside class="column">
    ...
    <section class="panel keys" aria-labelledby="lab-keys">
      ...
      <dl class="keys">
        ...
        <dt>JOYSTICK</dt><dd>arrows move · Z, X or space is FIRE · every other key types <span class="hint">the programs of the series read port 2; a game that wants a key on one screen and the stick on the next has both</span></dd>
