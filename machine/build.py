...
@media(max-width:1139px){{.machine{{grid-template-columns:1fr}}.screen{{max-width:768px}}}}   /* one column: the screen, not only the frame, is capped, so the badge hangs from the frame's corner and not the column's */
...
<div class="machine">
  ...
  <aside class="column">
    ...
    <section class="panel" aria-labelledby="lab-file">
