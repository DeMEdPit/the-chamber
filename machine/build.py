...
.bs .e.reading{{text-overflow:clip}}   /* the readout (readout.js): the cut part slides once to show its end; the mark of the cut goes while it moves */
.bs .f{{flex:none}}
...
<div class="machine">
  <div class="stage">
    ...
    <details class="panel bay logbox is-open" id="bay-log" open aria-labelledby="lab-log">
      <summary class="bh" aria-expanded="true" aria-controls="bay-log-body"><span class="lab"><span id="lab-log">THE LOG</span></span><span class="bs" id="sum-log"><span class="f"></span><span class="e"></span><span class="f"></span></span><span class="bm" aria-hidden="true"></span></summary>
  ...
  <aside class="column">
    <details class="panel bay chain is-open" id="bay-chain" open aria-labelledby="lab-chain">
      <summary class="bh" aria-expanded="true" aria-controls="bay-chain-body"><span class="lab"><span id="lab-chain">FROM THE CHAIN</span></span><span class="bs" id="sum-chain"><span class="f"></span><span class="e"></span><span class="f"></span></span><span class="bm" aria-hidden="true"></span></summary>
    ...
    <details class="panel bay file is-open" id="bay-file" open aria-labelledby="lab-file">
      <summary class="bh" aria-expanded="true" aria-controls="bay-file-body"><span class="lab"><span id="lab-file">FROM A FILE</span></span><span class="bs" id="sum-file"><span class="f"></span><span class="e"></span><span class="f"></span></span><span class="bm" aria-hidden="true"></span></summary>
    ...
    <details class="panel bay keys is-open" id="bay-keys" open aria-labelledby="lab-keys">
      <summary class="bh" aria-expanded="true" aria-controls="bay-keys-body"><span class="lab"><span id="lab-keys">THE KEYS</span></span><span class="bs" id="sum-keys"><span class="f"></span><span class="e"></span><span class="f"></span></span><span class="bm" aria-hidden="true"></span></summary>
