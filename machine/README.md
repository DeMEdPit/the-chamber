...
| `readout.js` | a line cut short in a bay's header slides once to show its end, on a phone, for a closed bay in view, never under reduced motion; one switch in host.js turns it off | MIT |
