...
| `readout.js` | a line cut short in a bay's header slides to show its end and back, on a phone, for a closed bay in view, never under reduced motion; one switch in host.js turns it off, one word picks the shape (bounce, or once) | MIT |
